...
This is the readme for jme-zombies, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Jmezombies) > Ok.
...
- To run the project find Jmezombies.java (which will be in under src/main/java/org/jme/zombies) and right click > Run 'Jmezombies'
